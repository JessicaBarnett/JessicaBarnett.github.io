            ...
            <div className="indent-2">
                ...
                <div className="paragraph-group">
                    <p className="indent-2 deco-font-3 ">
                        I've been crafting <em>beautiful user experiences</em> since 2014, and <em>high-quality backends</em> since 2021.  I strive to <em>use technology to make people's lives easier</em>, one tappity-tap at a time.
                    </p>
                </div>
